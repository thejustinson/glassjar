...
export function PortfolioEmptyState() {
  ...
  return (
    <div className="relative py-16 px-4 flex flex-col items-center justify-center max-w-2xl mx-auto text-center">
      ...
      {/* Hero Icon */}
      <div className="relative w-20 h-20 rounded-3xl bg-bg-card border border-border/80 flex items-center justify-center shadow-2xl mb-6">
      ...
      <button
        ...
        className="h-11 px-6 rounded-full text-sm font-bold bg-accent text-[#08090C] hover:bg-[#45c381] shadow-[0_0_20px_rgba(59,178,115,0.35)] transition-all duration-200 flex items-center gap-2 cursor-pointer select-none"
      >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full mt-12 text-left">
        <div className="p-4 rounded-2xl bg-bg-card/70 border border-border/60">
          <div className="w-8 h-8 rounded-xl bg-accent/10 border border-accent/20 flex items-center justify-center text-accent mb-3">
